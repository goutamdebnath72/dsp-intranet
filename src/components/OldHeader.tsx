...
const OldHeader: React.FC = () => {
  ...
  return (
    ...
    <header className="w-full md:w-[var(--content-width)] mx-auto bg-neutral-50 text-neutral-800 flex items-center justify-between px-4 sm:px-8 py-3 shadow-sm border-b border-neutral-200 sticky top-0 z-50">
      ...
      <div className="relative">
        {status === "authenticated" ? (
          <div ref={dropdownRef}>
            ...
            >
              <span className="hidden sm:inline font-semibold text-right text-neutral-700">
                {session.user.name}
              </span>

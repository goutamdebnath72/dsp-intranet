          ...
          .map((item) => {
            ...
            const wrapperProps = {
              onClick: hasContent
                ...
                : undefined,
              className: `w-full p-4 bg-white rounded-lg border border-neutral-200/80 shadow-sm text-left ${
              ...
              >
                <WrapperComponent {...wrapperProps}>
                  <div className="flex gap-3">
                    ...
                    {showNewChip && (
                      <span className="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full flex-shrink-0">
                        New
                      </span>
                    )}
                  </div>
  ...
  return (
    <>
      ...
      <div className="flex flex-col h-full bg-gray-100 rounded-lg border">
        <div className="flex-1 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-neutral-300 hover:scrollbar-thumb-neutral-400">
          {renderContent()}
        </div>
      </div>

        ...
        {departmentData.map((dept) => {
          ...
          return (
            ...
            <motion.a
              key={dept.id}
              href={dept.href}
              className="flex flex-col items-center justify-center p-4 border border-transparent rounded-lg text-center text-neutral-700 font-medium transition-colors duration-200 hover:bg-primary-100/50"
              whileHover={{
                scale: 1.05,
                y: -5,

...
export function HomepageNew({
  ...
  return (
    <>
      {/* --- Top Bar / Header --- */}
      <div className="relative z-50 w-full lg-custom:w-[75%] xl-custom:w-[70%] mx-auto">
        <TopBar />
      </div>
      <Header />
      ...
      {/* --- Hero Section --- */}
      <div
        className="w-full lg-custom:w-[75%] xl-custom:w-[70%] mx-auto bg-cover bg-center relative h-[455px]"
      ...
      <div className="w-full lg-custom:w-[75%] xl-custom:w-[70%] mx-auto bg-white pt-20 sm:pt-24 lg:pt-24 pb-8 px-4 sm:px-6 lg:px-8">
        <QuickAccessBar
      ...
      <motion.div
         className="w-full lg-custom:w-[75%] xl-custom:w-[70%] mx-auto bg-white py-12 sm:py-16 lg:py-16"
      ...
      <div className="w-full lg-custom:w-[75%] xl-custom:w-[70%] mx-auto bg-white rounded-lg py-4 sm:py-6 lg:py-8 mb-8">

        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          >
            ...
            {announcementsData && announcementsData
              .slice()
              // -- FIX 1 -- Reverted to fromISO() to parse the date string from the API
              .sort((a, b) => DateTime.fromISO(b.date as any).toMillis() - DateTime.fromISO(a.date as any).toMillis())
              .map((item) => {
                const hasContent = !!item.content;
                // -- FIX 1 -- Reverted to fromISO() to parse the date string
                ...
                return (
                  <div key={item.id} className="border-b border-neutral-200/50 last:border-b-0 pb-4 last:pb-0">
                    <div className="flex items-center justify-between">
                      ...
                      {(() => {
                        // -- FIX 2 --
                        // Clickability is now based *only* on the "New" chip being visible
                        // for a logged-in user on a headless announcement.
                        ...
                        if (hasContent) {
                          return (
                            ...
                            >
                              <MessageSquareText size={16} className="opacity-70 flex-shrink-0" />
                    ...
                    <p className="text-sm text-neutral-600 mt-1">
                      {/* (This line is confirmed correct, on a single line) */}

...
async function main() {
  ...
  // 3. Create announcements using Luxon
  await prisma.announcement.createMany({
    data: [
      { title: 'Circular on Refractory Taskforce Meeting', date: DateTime.fromISO('2025-09-30T00:00:00Z').toJSDate() },
      { title: 'OT-GT circular amendments of Contract Cases', date: DateTime.fromISO('2025-09-28T00:00:00Z').toJSDate() },
      { title: 'Preventive Vigilance Bulletin - September Edition', date: DateTime.fromISO('2025-09-25T00:00:00Z').toJSDate() },
    ],
    skipDuplicates: true,
  });
